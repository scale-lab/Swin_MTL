...
_C.MODEL.SKIP_DECODER_CKPT = False
...
_C.TRAIN.CONTROLLERS_PRETRAIN = False
_C.TRAIN.MTL_MULTI_OBJECTIVE_TRAIN = False
...
def update_config(config, args):
    ...
    if _check_args('skip_decoder'):
        config.MODEL.SKIP_DECODER_CKPT = args.skip_decoder
